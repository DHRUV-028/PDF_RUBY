...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference("Info.count") do
      post infos_url, params: { info: { amount: @info.amount, billNo: @info.billNo, firmName: @info.firmName, location: @info.location, orderNo: @info.orderNo } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { amount: @info.amount, billNo: @info.billNo, firmName: @info.firmName, location: @info.location, orderNo: @info.orderNo } }
